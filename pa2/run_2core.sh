...
TRACE_DIR1="/home/imnothackr/cs_core/cs773/pa2"  #path of the first trace file (excluding the trace file name)
TRACE_DIR2="/home/imnothackr/cs_core/cs773/pa2"  #path of the second trace file (excluding the trace file name)
binary=${1}
num1=${2}
num2=${3}
